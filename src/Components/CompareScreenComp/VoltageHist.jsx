      ...
      try {
        ...
        const datasets = [
          ...
          },
          {
            ...
            data: secondFeederResampledData.map((item) => item["ry_voltage"]),
            borderColor: "#DC8006",
            borderWidth: 2,
            pointRadius: 0,
            pointHoverRadius: 0,
          ...
          },
          {
            ...
            data: secondFeederResampledData.map((item) => item["yb_voltage"]),
            borderColor: "#16896B",
            borderWidth: 2,
            pointRadius: 0,
            pointHoverRadius: 0,
          ...
          },
          {
            ...
            data: secondFeederResampledData.map((item) => item["br_voltage"]),
            borderColor: "#6036D4",
            borderWidth: 2,
            pointRadius: 0,
            pointHoverRadius: 0,
